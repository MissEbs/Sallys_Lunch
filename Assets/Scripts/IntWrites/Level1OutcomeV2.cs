...
public class Level1OutcomeV2 : MonoBehaviour
{
    ...
    public void ChangeStory(string Pathfind)
    {
    ...
    void OnClickChoiceButton(Choice choice)
    {
        ...
        if (choice.text.StartsWith("...")) //when pressing on ...
        {
            RemoveChildren();
            myplayer.Move = true;
        }
    ...
    Button CreateChoiceView(string text)
    {
        ...
        choice.transform.position = ContinueSpot.position;
